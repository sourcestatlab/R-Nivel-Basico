...
<p align="center"> <img src="images/install3.jpeg" border="0" width="350" height="160"> </p>

> - Elegimos entre los 3 subdirectorios: _base_, _contrib_ y _RTools_. Damos click sobre _base_.

<p align="center"> <img src="images/install4.jpeg" border="0" width="350" height="160"> </p>
...
<p align="center"> <img src="images/fig1.jpeg" border="0" width="190" height="150"> 
<img src="images/fig2.jpeg" border="0" width="190" height="150"> 
<img src="images/fig3.jpeg" border="0" width="190" height="150">
<img src="images/fig4.jpeg" border="0" width="190" height="150"> </p>

> - Aceptamos todo por default

<p align="center"> <img src="images/fig5.jpeg" border="0" width="190" height="150"> 
<img src="images/fig6.jpeg" border="0" width="190" height="150"> 
<img src="images/fig7.jpeg" border="0" width="190" height="150">
<img src="images/fig8.jpeg" border="0" width="190" height="180"> </p>
...
#### METÁFORA:
Imaginemos que hemos adquirido un auto el cual cumple con ciertas funciones principales y no trae contratiempos, una vez que lo empezamos a rodar nos vamos dando cuenta de la necesidad de mejorar el rendimiento de ciertos mecanismos ya existentes del auto debido que lo vamos exponiendo a diferentes ambientes y condiciones. Lo anterior pasa exactamente con R, cuando  descargamos e instalamos el sotfware contamos con ciertas características y paquetes básicos pero existen miles de paquetes adicionales que pueden ser agregados para lograr mejorar su funcionalidad y a la vez realizar cosas estupendas.
...
Una vez conocido el nombre del paquete a instalarse basta con introducir el siguiente comando en la consola:
```{r, results='hold', eval=FALSE}
install.packages("nombre_paquete")
```
Ciertos paquetes de R requieren la instalación de otros paquetes adicionales debido que entre estos comparten algunas funciones, para evitar tener inconvenientes con la instalación de un paquete se aconseja adicionar: 
```{r, results='hold', eval=FALSE}
...
El listado completo de los paquetes instalados lo visualizamos tecleando __library( )__. Si deseamos conocer el lugar en el cual se instalan los paquetes usamos:
```{r, results='hold'}
.libPaths()
```
Conocer la totalidad de paquetes que se encuentran albergados en la CRAN, y a su vez verificar cuales de ellos se encuentran válidos y disponibles para su uso es posible mediante:
```{r, results='hold', eval=FALSE}
installed.packages()
available.packages()
```
...
```
Podemos enlistar todas las funciones que han sido implementadas dentro de un paquete, por ejemplo:
```{r, results='hold', eval=FALSE}
library(foreign)
ls('package:foreign')
```
...
<p align="center"> <img src="images/rro.jpeg" border="0" width="220" height="200"> </p>
...
> - Puede descargarse desde http://www.revolutionanalytics.com como __Revolution R Open__ de forma gratuita, sin embargo en el caso de requerir soporte se puede adquirir la versión pagada __Revolution R Enterprise__.
